...
namespace Prover.CommProtocol
{
    public class Enums
    {
        ...
        public enum InstrumentErrorsEnum
        {
            ...
            CheckByteError = 23,
            //Check byte error
            InvalidAccessCodeError = 27,
            //Invalid Access Code Error
            InvalidCommandError28,
            //Invalid Command Error
            InvalidItemNumberError = 29,
            //Invalid Item Number
            InvalidEnquiryError = 30,
            //Invalid Enquiry
            TooManyRetransmissionsError = 31,
            //Too many retransmissions
            ReadOnlyError = 32,
            //Attempted access is disabled. item is read-only
            NoAuditTrailError = 33,
            //No audit trail
            EventLoggerFullError = 34,
            //Event logger full
