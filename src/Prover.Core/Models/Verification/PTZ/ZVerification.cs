...
{
    public class ZVerification : PTZBase
    {
        ...
        public ZVerification(Instrument instrument, TestLevel level, TVerification temperature, PVerification pressure) : base(instrument, level)
        {
            TemperatureTest = temperature;
            PressureTest = pressure;
        }

        public TVerification TemperatureTest { get; private set; }
        public PVerification PressureTest { get; private set; }
        ...
        public override decimal? ActualFactor
        {
            get
            {
                return decimal.Round((decimal)CalculateFPV(), 4);
            }
        }
        ...
        private double CalculateFPV()
        {
            switch (SuperTable)
            {
                case SuperFactorTable.AGA8:
                    throw new NotImplementedException("AGA8 Super. Factor calculations aren't implemented yet.");
                default:
